...
describe('service', function() {
  ...
  describe('loginService', function() {
    ...
    describe('#changePassword', function() {
      ...
      it('should fail if $firebaseSimpleLogin fails',
        inject(function(loginService, $firebaseSimpleLogin, $timeout, $q) {
          var cb = jasmine.createSpy();
          customSpy($firebaseSimpleLogin.fns, '$changePassword', function() {
            var def = $q.defer();
    ...
    describe('#createAccount', function() {
      beforeEach(inject(function($timeout, $firebaseSimpleLogin, $q) {
        customSpy($firebaseSimpleLogin.fns, '$createUser', function() {
          var def = $q.defer();
  ...
  function firebaseStub() {
    ...
    customSpy(FirebaseStub.fns, 'set', function(value, cb) { if (cb) { cb(FirebaseStub.fns.callbackVal); } });
